...
#[utoipa::path(
    ...
    params(
        (
            "word_uuid" = String,
            Path,
            description = "ID of the slovene word."
        )
    ),
    responses(
        (
...
#[patch("/{word_uuid}")]
pub async fn update_a_specific_slovene_word(
    state: ApplicationState,
    authentication: UserAuthenticationExtractor,
    parameters: web::Path<(String,)>,
...
#[utoipa::path(
    ...
    params(
        (
            "word_uuid" = String,
            Path,
            description = "ID of the slovene word to delete."
        )
    ),
    responses(
        (
...
#[delete("/{word_uuid}")]
pub async fn delete_a_specific_slovene_word(
    state: ApplicationState,
    authentication: UserAuthenticationExtractor,
    parameters: web::Path<(String,)>,
) -> EndpointResult {
...
pub fn slovene_dictionary_router() -> Scope {
    web::scope("/slovene")
        ...
        .service(update_a_specific_slovene_word)
        .service(delete_a_specific_slovene_word)
}
