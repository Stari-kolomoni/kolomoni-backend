...
#### A.2 Generating entity code from the modified schema
...
#### A.3 Defining relevant queries and mutations on top of the generated entities
> The following takes place in the `kolomoni_database` crate.
