...
CREATE TABLE kolomoni.permission (
	...
	CONSTRAINT pk__permission PRIMARY KEY (id),
	CONSTRAINT unique__permission__name UNIQUE (name)
);
...
-- We set the fillfactor to 100 because permissions will be very rarely modified.
CREATE INDEX index__permission__name
    ON kolomoni.permission (id)
    WITH (FILLFACTOR = 100);
...
CREATE TABLE kolomoni.role (
    ...
    CONSTRAINT unique__role__name UNIQUE (name)
);
...
-- We set the fillfactor to 100 because roles will be very rarely modified.
CREATE INDEX index__role__name
    ON kolomoni.role (name)
    WITH (FILLFACTOR = 100);
...
CREATE TABLE kolomoni.role_permission (
    ...
    CONSTRAINT fk__role_permission__role_id__role FOREIGN KEY (role_id)
        REFERENCES kolomoni.role (id)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk__role_permission__permission_id__permission FOREIGN KEY (permission_id)
...
CREATE TABLE kolomoni.user (
    ...
    CONSTRAINT unique__user__username UNIQUE (username),
    CONSTRAINT unique__user__display_name UNIQUE (display_name)
);
...
CREATE TABLE kolomoni.user_role (
    ...
    CONSTRAINT fk__user_role__user_id__user FOREIGN KEY (user_id)
        REFERENCES kolomoni.user (id)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk__user_role__role_id__role FOREIGN KEY (role_id)
        REFERENCES kolomoni.role (id)
        ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE kolomoni.category (
    ...
    CONSTRAINT unique__category__slovene_name UNIQUE (slovene_name),
    CONSTRAINT unique__category__english_name UNIQUE (english_name),
    CONSTRAINT fk__category__parent_category_id__category FOREIGN KEY (parent_category_id)
...
CREATE TABLE kolomoni.word_slovene (
    ...
    lemma text NOT NULL,
    CONSTRAINT pk__word_slovene PRIMARY KEY (word_id),
    CONSTRAINT fk__word_slovene__word_id__word FOREIGN KEY (word_id)
...
CREATE TABLE kolomoni.word_english (
    word_id uuid NOT NULL,
    lemma text NOT NULL,
    CONSTRAINT pk__word_english PRIMARY KEY (word_id),
    CONSTRAINT fk__word_english__word_id__word FOREIGN KEY (word_id)
        REFERENCES kolomoni.word (id)
        ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE kolomoni.word_meaning (
    id uuid NOT NULL,
    word_id uuid NOT NULL,
    CONSTRAINT pk__word_meaning PRIMARY KEY (id),
    CONSTRAINT fk__word_meaning__word_id__word FOREIGN KEY (word_id)
        REFERENCES kolomoni.word (id)
        ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE kolomoni.word_meaning_category (
    ...
    CONSTRAINT pk__word_meaning_category PRIMARY KEY (word_meaning_id, category_id),
    CONSTRAINT fk__word_meaning__word_meaning_id__word_meaning FOREIGN KEY (word_meaning_id)
        REFERENCES kolomoni.word_meaning (id)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk__word_meaning__category_id__category FOREIGN KEY (category_id)
        REFERENCES kolomoni.category (id)
        ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE kolomoni.word_slovene_meaning (
    ...
    created_at timestamp with time zone NOT NULL,
    last_modified_at timestamp with time zone NOT NULL,
    CONSTRAINT pk__word_slovene_meaning PRIMARY KEY (word_meaning_id),
    CONSTRAINT fk__word_slovene_meaning__word_meaning_id__word_meaning FOREIGN KEY (word_meaning_id)
        REFERENCES kolomoni.word_meaning (id)
        ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE kolomoni.word_english_meaning (
    ...
    created_at timestamp with time zone NOT NULL,
    last_modified_at timestamp with time zone NOT NULL,
    CONSTRAINT pk__word_english_meaning PRIMARY KEY (word_meaning_id),
    CONSTRAINT fk__word_english_meaning__word_meaning_id__word_meaning FOREIGN KEY (word_meaning_id)
        REFERENCES kolomoni.word_meaning (id)
        ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE kolomoni.word_meaning_translation (
    ...
    translated_by uuid,
    CONSTRAINT pk__word_translation PRIMARY KEY (slovene_word_meaning_id, english_word_meaning_id),
    CONSTRAINT fk__word_translation__slovene_word_meaning_id__word_meaning FOREIGN KEY (slovene_word_meaning_id)
        REFERENCES kolomoni.word_meaning (id)
        ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE kolomoni.word_meaning_edit (
    ...
    performed_by uuid,
    -- Records the username and display time at the time of the edit.
    performed_by_username_snapshot text,
    CONSTRAINT pk__word_meaning_edit PRIMARY KEY (id),
    CONSTRAINT fk__word_meaning_edit__word_meaning_id__word_meaning FOREIGN KEY (word_meaning_id)
        REFERENCES kolomoni.word_meaning (id)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk__word_meaning_edit__performed_by__user FOREIGN KEY (performed_by)
        REFERENCES kolomoni.user (id)
        ON UPDATE CASCADE ON DELETE SET NULL
);
