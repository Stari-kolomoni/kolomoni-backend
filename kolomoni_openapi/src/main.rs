...
#[openapi(
    ...
    components(
        schemas(
            ...
            api_models::InvalidJsonBodyReason,
            // Unnecessary:
            ...
            // Implements IntoParams, unnecessary:
